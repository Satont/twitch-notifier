...
func (cc *ChatCreate) SetChatSettingsID(id uuid.UUID) *ChatCreate {
	cc.mutation.SetChatSettingsID(id)
	return cc
}

// SetChatSettings sets the "chat_settings" edge to the ChatSettings entity.
func (cc *ChatCreate) SetChatSettings(c *ChatSettings) *ChatCreate {
	return cc.SetChatSettingsID(c.ID)
}
...
func (cc *ChatCreate) check() error {
	...
	if _, ok := cc.mutation.ChatSettingsID(); !ok {
		return &ValidationError{Name: "chat_settings", err: errors.New(`ent: missing required edge "Chat.chat_settings"`)}
	}
	return nil
}
...
func (cc *ChatCreate) createSpec() (*Chat, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.ChatSettingsIDs(); len(nodes) > 0 {
