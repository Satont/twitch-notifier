...
(
    ...
    "chat_id"    uuid NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "follows_channels_follows" FOREIGN KEY ("channel_id") REFERENCES "channels" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT "follows_chats_follows" FOREIGN KEY ("chat_id") REFERENCES "chats" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
