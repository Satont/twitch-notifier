...
// QueryChatSettings queries the chat_settings edge of a Chat.
func (c *ChatClient) QueryChatSettings(ch *Chat) *ChatSettingsQuery {
...
// QueryOwner queries the owner edge of a ChatSettings.
func (c *ChatSettingsClient) QueryOwner(cs *ChatSettings) *ChatQuery {
