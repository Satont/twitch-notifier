...
type ChatEdges struct {
	// ChatSettings holds the value of the chat_settings edge.
...
// ChatSettingsOrErr returns the ChatSettings value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e ChatEdges) ChatSettingsOrErr() (*ChatSettings, error) {
	if e.loadedTypes[0] {
		if e.ChatSettings == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: chatsettings.Label}
		}
		return e.ChatSettings, nil
	}
	return nil, &NotLoadedError{edge: "chat_settings"}
}
...
// QueryChatSettings queries the "chat_settings" edge of the Chat entity.
func (c *Chat) QueryChatSettings() *ChatSettingsQuery {
	return NewChatClient(c.config).QueryChatSettings(c)
}
